...
public class beat_detection_frequency extends PApplet {
...
public void setup()
{
  ...
  input = minim.getLineIn(Minim.STEREO, PApplet.parseInt(1024), PApplet.parseInt(44100));
 
  // a beat detection object that is FREQ_ENERGY mode that 
  // expects buffers the length of song's buffer size
  // and samples captured at songs's sample rate
  beat = new BeatDetect( PApplet.parseInt(1024), PApplet.parseInt(44100) );
...
public void draw()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "beat_detection_frequency" };
    if (passedArgs != null) {
